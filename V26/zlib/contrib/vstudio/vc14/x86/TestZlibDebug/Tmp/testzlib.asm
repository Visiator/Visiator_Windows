; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\prj\Visiator_Windows\V26\zlib\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG96394 DB	'rb', 00H
	ORG $+5
$SG96455 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG96458 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG96459 DB	'file %s read, %u bytes', 0aH, 00H
$SG96463 DB	'1.2.11', 00H
	ORG $+1
$SG96464 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG96465 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG96466 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG96467 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG96468 DB	'1.2.11', 00H
	ORG $+1
$SG96469 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG96470 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG96471 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG96472 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG96475 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\prj\visiator_windows\v26\zlib\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
